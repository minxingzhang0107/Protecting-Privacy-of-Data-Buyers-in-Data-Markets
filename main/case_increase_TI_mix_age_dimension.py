...
if __name__ == '__main__':
    ...
    ## expand on age for PI-uniform attack
    w_1 = 0.5
    w_2 = 1 - w_1
    ...
    for x, y, label in zip(expanded_feature_name_list, confidence_lower_PI_uniform_attack,
        ...
        plt.annotate(formatted_label, (x, y), textcoords="offset points", xytext=(0, -14), ha='center', fontsize=15,
                     color='blue')
